...
# --- Usuarios ---
tk.Label(ventana, text="--- Registro de Usuarios :D ---").pack(pady=5)
tk.Label(ventana, text="---  Digite su nombre, contraseña y correo! ---").pack(pady=5)
...
btn_guardar = tk.Button(ventana, text="Guardar Usuario", command=guardar_usuario, bg="green", fg="white")
btn_guardar.pack(pady=5)

btn_eliminar = tk.Button(ventana, text="Eliminar Usuario", command=eliminar_usuario, bg="red", fg="white")
...
# To-Do List ^_^
tk.Label(ventana, text="--- Agregar tareas aqui  ---").pack(pady=10)

entry_tarea = tk.Entry(ventana, width=30)
entry_tarea.pack(pady=5)

btn_agregar_tarea = tk.Button(ventana, text="Agregar Tarea", command=agregar_tarea, bg="purple", fg="white")
btn_agregar_tarea.pack(pady=5)

listbox_tareas = tk.Listbox(ventana, width=50, height=10)
listbox_tareas.pack(pady=10)

btn_eliminar_tarea = tk.Button(ventana, text="Eliminar Tarea Seleccionada", command=eliminar_tarea, bg="orange", fg="white")
